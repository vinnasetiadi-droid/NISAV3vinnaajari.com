  ...
  return (
    <ToastProvider>
      <div className="bg-app-light flex h-screen overflow-hidden">
        {/* sidebar floating glass — memanjang penuh sampai bawah */}
        <div className="flex min-h-0 shrink-0 flex-col p-2.5 pr-0">
          <Suspense fallback={<div className="w-[236px] flex-1" />}>
            <Sidebar />
          </Suspense>
        </div>
        {/* konten + baris status di bawahnya (sejajar dasar sidebar) */}
